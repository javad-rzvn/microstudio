...
this.RateLimiter = class RateLimiter {
  constructor(server) {
    ...
    this.map.ai_fix_error_ip = new RateLimiterClass(this, 60, 20);
    this.map.ai_fix_error_user = new RateLimiterClass(this, 60, 20);
    this.map.ai_fix_error_project = new RateLimiterClass(this, 24 * 60, 60);
